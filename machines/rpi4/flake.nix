{
  description = ''
    ...
    Build iso image:
    nix run github:nix-community/nixos-generators -- --flake ".#rpi4" -f iso
  ...
  outputs = { self, nixpkgs, home-manager }@inputs: {
    ...
    #     # Uncomment the next line for running QEMU on a non-graphical system # virtualisation.graphics = false;
    #   };
    # };
    ...
    nixosConfigurations = {
      rpi4 = (nixpkgs.lib.makeOverridable nixpkgs.lib.nixosSystem) {
        system = "aarch64-linux";
        modules = [ ./rpi4-image.nix ./graphics.nix ];
      };
      # OS: NixOS
